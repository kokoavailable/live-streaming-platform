10k starts 를 가진 오픈 소스 프로젝트인 golive 를 커스텀 하고 클론 코딩 하며 주석등을 제공하고 새롭게 리드미를 작성해 제작했습니다.
...
3. 업스트림 푸쉬
RTMP 프로토콜을 통해 채널 키를가지고 
`rtmp://localhost:1935/{appname}/{channelkey}` 비디오 스트림을 푸시합니다.
